...
def main(img_path=None, vid_path=None,vid_out = None):
    ...
    model =  torch.hub.load('C:\\Users\\patid\\Downloads\\yolov5_deploy\\yolov5-master', 'custom', source ='local', path='last.pt',force_reload=True) ### The repo is stored locally
